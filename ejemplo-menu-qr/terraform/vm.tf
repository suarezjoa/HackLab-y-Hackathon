...
#    2) La VM en sí, con un script de arranque que solo instala Docker + docker
#       compose (nada de configuración extra).
# =============================================================================
...
resource "google_compute_instance" "vm" {
  ...
  # solo instala Docker y el plugin de docker compose. Nada más.
